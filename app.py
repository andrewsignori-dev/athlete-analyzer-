...
with st.expander("🧮 Show simulated dataset and exploratory analysis"):
    ...
    ax_age.set_ylabel("Injury Rate", fontsize=font_size-4)
    ax_age.set_xlabel("Age Group", fontsize=font_size-4)
    ax_age.tick_params(axis='x', rotation=45, labelsize=font_size-4)
    ax_age.tick_params(axis='y', labelsize=font_size-4)
    fig_age.tight_layout()
    st.pyplot(fig_age)
    ...
    fig_sport, ax_sport = plt.subplots(figsize=(fig_width_small, fig_height_small))
    sns.barplot(x="Sport", y="Injury", data=sport_rate, palette="Set2", ax=ax_sport)
    ax_sport.set_ylabel("Injury Rate", fontsize=font_size-4)
    ax_sport.set_xlabel("Sport", fontsize=font_size-4)
    ax_sport.tick_params(axis='x', rotation=45, labelsize=font_size-4)
    ax_sport.tick_params(axis='y', labelsize=font_size-4)
    fig_sport.tight_layout()
    st.pyplot(fig_sport)
    ...
    ax_workload.set_xlabel("Injury", fontsize=font_size-4)
    ax_workload.set_ylabel("Workload", fontsize=font_size-4)
    ax_workload.tick_params(axis='x', labelsize=font_size-4)
    ax_workload.tick_params(axis='y', labelsize=font_size-4)
    ...
    ax_heat.set_ylabel("Age Group", fontsize=font_size-4)
    ax_heat.set_xlabel("Sport", fontsize=font_size-4)
